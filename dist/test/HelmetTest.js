...
describe("Helmet", function () {
    ...
    describe("api", function () {
        ...
        describe("base tag", function () {
            ...
            it("tags without 'target' or 'href' will not be accepted", function () {
                _reactAddons2["default"].render(_reactAddons2["default"].createElement(_index2["default"], {
        ...
        describe("link tags", function () {
            ...
            it("tags without 'href' or 'rel' will not be accepted", function () {
                _reactAddons2["default"].render(_reactAddons2["default"].createElement(_index2["default"], {
    ...
    describe("server", function () {
        ...
        var stringifiedMetaTags = ["<meta " + HELMET_ATTRIBUTE + "=\"true\" property=\"og:type\" content=\"article\">", "<meta " + HELMET_ATTRIBUTE + "=\"true\" http-equiv=\"content-type\" content=\"text/html\">", "<meta " + HELMET_ATTRIBUTE + "=\"true\" name=\"description\" content=\"Test description\">", "<meta " + HELMET_ATTRIBUTE + "=\"true\" charset=\"utf-8\">"].join("");

        var stringifiedLinkTags = ["<link " + HELMET_ATTRIBUTE + "=\"true\" href=\"http://localhost/style.css\" rel=\"stylesheet\" type=\"text/css\">", "<link " + HELMET_ATTRIBUTE + "=\"true\" href=\"http://localhost/helmet\" rel=\"canonical\">"].join("");
        ...
        it("will render base tag as React component", function () {
            ...
            expect(head.base).to.be.an("array").that.has.length.of(1);

            head.base.forEach(function (base) {
        ...
        it("will render meta tags as React components", function () {
            ...
            expect(head.meta).to.be.an("array").that.has.length.of(4);

            head.meta.forEach(function (meta) {
        ...
        it("will render link tags as React components", function () {
            ...
            expect(head.link).to.be.an("array").that.has.length.of(2);

            head.link.forEach(function (link) {
        ...
        it("supports head.base.toString()", function () {
            _reactAddons2["default"].render(_reactAddons2["default"].createElement(_index2["default"], {
                base: { "target": "_blank", "href": "http://localhost/" }
            }), container);
            ...
            var baseToString = head.base.toString();

            expect(baseToString).to.be.a("string").that.equals(stringifiedBaseTag);
        });

        it("supports head.meta.toString()", function () {
            _reactAddons2["default"].render(_reactAddons2["default"].createElement(_index2["default"], {
                meta: [{ "charset": "utf-8" }, { "name": "description", "content": "Test description" }, { "http-equiv": "content-type", "content": "text/html" }, { "property": "og:type", "content": "article" }]
            }), container);
            ...
            var metaToString = head.meta.toString();

            expect(metaToString).to.be.a("string").that.equals(stringifiedMetaTags);
        });

        it("supports head.link.toString()", function () {
            _reactAddons2["default"].render(_reactAddons2["default"].createElement(_index2["default"], {
                link: [{ "href": "http://localhost/helmet", "rel": "canonical" }, { "href": "http://localhost/style.css", "rel": "stylesheet", "type": "text/css" }]
            }), container);
            ...
            var linkToString = head.link.toString();

            expect(linkToString).to.be.a("string").that.equals(stringifiedLinkTags);
        });
