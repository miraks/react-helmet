...
var getBaseTagFromPropsList = function getBaseTagFromPropsList(propsList) {
    var baseTag = getInnermostProperty(propsList, "base");
...
var mapStateOnServer = function mapStateOnServer(_ref) {
    ...
    return {
        ...
        base: generateTagsAsReactComponent(_HelmetConstantsJs.TAG_NAMES.BASE, baseTag),
        meta: generateTagsAsReactComponent(_HelmetConstantsJs.TAG_NAMES.META, metaTags),
        link: generateTagsAsReactComponent(_HelmetConstantsJs.TAG_NAMES.LINK, linkTags)
    };
};
